  ...
  return (
    <div style={S.authContainer}>
      <div style={S.authCard}>
        <h1 style={S.authTitle}>Best Self</h1>
        <p style={S.authSubtitle}>Daily habits, better life</p>
        ...
        <span style={S.authSkip} onClick={onSkip}>
          Continue without account
        </span>

        <p style={{ ...S.settingsNote, marginTop: 32, fontSize: 12 }}>
